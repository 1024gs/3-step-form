import {c as createCommonjsModule}from'./_commonjsHelpers.js';import {r as react}from'./index3.js';var k = Object.assign;
...
var D = react.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
...
var $a = function () {
  function a(a, b) {
    react.isValidElement(a) ? a.type !== u ? a = [a] : (a = a.props.children, a = react.isValidElement(a) ? [a] : Z(a)) : a = Z(a);
    a = {
      type: null,
  ...
  b.render = function (a, b, f) {
    ...
    if ("object" === typeof c && null !== c) switch (c.$$typeof) {
      ...
      case ia:
        return a = [react.createElement(c.type, k({
          ref: a.ref
      ...
      case ja:
        switch (c = a.type, na(c), c._status) {
          case 1:
            return a = [react.createElement(c._result, k({
              ref: a.ref
            }, a.props))], this.stack.push({
              type: null,
              domNamespace: f,
